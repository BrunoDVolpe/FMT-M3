...
module.exports = {
  ...
  //dialectModule: pg //Na versão 4 às vezes não funciona apenas mencionando o dialeto como postgres. Ao invés disso, precisamos importar o módulo e passar dessa forma
};